...
import se.skltp.ei.entity.model.util.Hash;
...
@Table(name=Engagement.ENGAGEMENT_INDEX_TABLE,
indexes={ @Index(name=Engagement.ENGAGEMENT_SEARCH_INDEX,
    columnList = Engagement.INDEX_COLUMN_LIST ) })
public class Engagement implements BusinessKey {
    ...
    static final String INDEX_COLUMN_LIST = Engagement.REGISTERED_RESIDENT_ID +","+Engagement.SERVICE_DOMAIN+","+Engagement.CATEGORIZATION;
