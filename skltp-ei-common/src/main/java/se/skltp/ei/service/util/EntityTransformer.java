...
public class EntityTransformer {
   ...
   */
  static ThreadLocal<SimpleDateFormat> dateFormatters = ThreadLocal.withInitial(() -> {
  ...
  public static Date dateDaysFromDate(Date pDate, int pDays) {
    checkState(pDate != null, "Please make sure pDate is Assigned");
  ...
  public static String dateDaysFromStrDate(String pStrDate, int pDays) {
    checkArgument(pStrDate != null, "pStrDate must be assigned");
