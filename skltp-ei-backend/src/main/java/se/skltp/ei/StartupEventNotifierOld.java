...
import se.skltp.ei.subscriber.SubscriberCacheEventListenerOld;
import se.skltp.ei.subscriber.SubscriberService;


//@Log4j2
//@Component
public class StartupEventNotifierOld /*extends EventNotifierSupport*/ {
//
...
//    } else if (event instanceof ExchangeCreatedEvent || event instanceof ExchangeSentEvent) {
...
//    final SubscriberCacheEventListenerOld subscriberCacheEventListenerOld =
//        SubscriberCacheEventListenerOld.createInstance(camelContext, maximumRedeliveries, redeliveryDelay, useExponentialBackoff, backOffMultiplier, maximumRedeliveryDelay);
//    ehCacheManager.getCache("subscriber-cache").getCacheEventNotificationService().registerListener(subscriberCacheEventListenerOld);
//
